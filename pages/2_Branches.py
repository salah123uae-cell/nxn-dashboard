...
branches_raw = get_branches_cached()
data = [{
    t("id_col"): branch["id"], t("code_col"): branch["code"],
    t("name_ar_col"): branch["name_ar"], t("name_en_col"): branch["name_en"],
    t("region_col"): branch["region"], t("city_col"): branch["city"],
    t("status_col"): branch["status"],
    t("branch_manager_col"): branch["manager_email"] or "—",
