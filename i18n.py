...
TRANSLATIONS = {
    ...
    "setup_title": {"ar": "التهيئة الأولى — إنشاء حساب المالك", "en": "First-Time Setup — Create Owner Account"},
    ...
    "live_dashboard_title": {"ar": "لمحة سريعة (بيانات حيّة)", "en": "Quick Glance (Live Data)"},
    "notifications_title": {"ar": "الإشعارات", "en": "Notifications"},
    "no_notifications": {"ar": "لا توجد إشعارات", "en": "No notifications"},
    "mark_all_read_btn": {"ar": "تحديد الكل كمقروء", "en": "Mark all as read"},
    "mark_read_btn": {"ar": "تحديد كمقروء", "en": "Mark as read"},
    "select_all_label": {"ar": "تحديد الكل", "en": "Select all"},
    "select_row_label": {"ar": "تحديد", "en": "Select"},
    "bulk_approve_btn": {"ar": "قبول المحدد ({n})", "en": "Approve selected ({n})"},
    "bulk_approve_done_toast": {"ar": "تم قبول الطلبات المحددة", "en": "Selected requests approved"},
    ...
    "open_corrective_actions": {"ar": "الإجراءات التصحيحية المفتوحة", "en": "Open Corrective Actions"},
    "no_open_actions": {"ar": "لا توجد إجراءات تصحيحية مفتوحة", "en": "No open corrective actions"},
    "branch_status_board": {"ar": "لوحة حالة الفروع", "en": "Branch Status Board"},
    ...
    "edit_branch_title": {"ar": "تعديل / تغيير حالة فرع", "en": "Edit / Change Branch Status"},
    ...
    "evidence_section_title": {"ar": "الأدلة المرفقة (صور / مستندات)", "en": "Attached Evidence (images / documents)"},
    "no_evidence_yet": {"ar": "لا توجد أدلة مرفقة بعد", "en": "No evidence attached yet"},
    "upload_evidence_label": {"ar": "أضيفي صورة أو مستند كدليل", "en": "Add an image or document as evidence"},
    "save_evidence_btn": {"ar": "حفظ الملف", "en": "Save File"},
    "evidence_saved_msg": {"ar": "تم حفظ الملف", "en": "File saved"},
    "download_btn": {"ar": "تحميل", "en": "Download"},

    # ---------- Corrective Actions ----------
    "corrective_actions_title": {"ar": "الإجراءات التصحيحية", "en": "Corrective Actions"},
    ...
    "edit_user_title": {"ar": "تعديل حالة مستخدم", "en": "Edit User Status"},
    ...
    "download_pdf_btn": {"ar": "تحميل تقرير PDF", "en": "Download PDF Report"},
    "export_all_title": {"ar": "تصدير كل التدقيقات", "en": "Export All Audits"},
    "export_all_excel_btn": {"ar": "تصدير الكل Excel", "en": "Export All (Excel)"},
    ...
    "ai_not_configured": {"ar": "**المساعد الذكي غير مفعّل بعد.**", "en": "**The AI Assistant is not enabled yet.**"},
    ...
    "clear_chat_btn": {"ar": "مسح المحادثة", "en": "Clear Chat"},
    "chat_limit_reached": {"ar": "وصلت للحد الأقصى من الرسائل بهذي الجلسة ({n} رسالة) للحفاظ على استهلاك معقول. حدّثي الصفحة لبدء جلسة جديدة.",
                            "en": "You've reached the message limit for this session ({n} messages) to keep usage reasonable. Refresh the page to start a new session."},
    ...
    "ai_setup_step2": {"ar": "2. في إعدادات الاستضافة: **Manage app / Settings / Secrets**، أضف مفتاح التفعيل هناك:", "en": "2. In hosting settings: **Manage app / Settings / Secrets**, add the activation key there:"},
    ...
    "backup_warning": {"ar": "**مهم جدًا**: قاعدة البيانات الحالية قد لا تكون دائمة على الاستضافة السحابية. نزّلي نسخة احتياطية بشكل دوري لتفادي فقدان البيانات.",
                        "en": "**Important**: The current database may not be permanent on cloud hosting. Download a backup regularly to avoid data loss."},
    "export_backup_title": {"ar": "تصدير نسخة احتياطية كاملة", "en": "Export Full Backup"},
    ...
    "export_backup_btn": {"ar": "تنزيل النسخة الاحتياطية", "en": "Download Backup"},
    "import_backup_title": {"ar": "استعادة من نسخة احتياطية", "en": "Restore from Backup"},
    "import_backup_desc": {"ar": "سيتم استبدال أي بيانات بنفس المعرّفات. استخدم هذا فقط عند نقل قاعدة البيانات أو الاستعادة بعد مشكلة.",
                            "en": "Existing data with matching IDs will be overwritten. Use this only when migrating databases or recovering from an issue."},
    "import_backup_uploader": {"ar": "اختر ملف النسخة الاحتياطية (JSON)", "en": "Choose backup file (JSON)"},
    "import_backup_btn": {"ar": "استعادة البيانات الآن", "en": "Restore Data Now"},
    ...
    "restore_setup_btn": {"ar": "استعادة كل شي من النسخة الاحتياطية", "en": "Restore Everything from Backup"},
