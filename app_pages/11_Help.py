    ...
    GUIDE_SECTIONS = [
        ...
        },
        {
            ...
            "table": [
                ...
                {"ar": ("موظف التدقيق", "إنشاء وتنفيذ التدقيقات الخاصة به"),
                 "en": ("Audit Officer", "Create and conduct their own audits")},
                {"ar": ("مدير الفرع", "متابعة تدقيقات فرعه والإجراءات التصحيحية الخاصة به"),
                 "en": ("Branch Manager", "Track their branch's audits and corrective actions")},
